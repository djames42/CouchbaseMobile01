...
docker run -d -v "$LOCPATH/data":/cb_share \
	...
	--name cb_sg couchbase:enterprise-6.6.3 >/dev/null
...
docker run -p 4984-4985:4984-4985 \
	...
	couchbase/sync-gateway:2.8.0-enterprise -adminInterface :4985 /etc/sync_gateway/sync-gateway-config.json >/dev/null
